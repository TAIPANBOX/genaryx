# Genaryx live-campaign archive

Preserved artifacts from the live Hetzner run of the TAIPANBOX stack under Genaryx
(org `meridian.example`, 2026-07-17/18). Box was torn down; everything needed to
re-run and to cite the numbers is here.

- **`RESULTS.md`** - the full record: verified live numbers (money/policy/identity),
