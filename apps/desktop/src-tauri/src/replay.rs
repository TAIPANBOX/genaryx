...
// ============================================================================
// pure logic (directly unit-testable without a live `tauri::State` wrapper -
...
pub fn run_events(run_id: String, limit: usize, state: tauri::State<'_, AppState>) -> Vec<UiEvent> {
